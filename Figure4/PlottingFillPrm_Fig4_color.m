...
plot(tx, ModelRates(2).TregDeath(:,1,1),'color', LineColorWT, 'LineWidth', LineWidth)%Plotting the means
hold on
plot(tx, ModelRates(2).TregDeath(:,1,2),'color', LineColorKO, 'LineWidth', LineWidth)%Plotting the means
...
plot(tx, StatsOfCells(:,1,3,1),'color', LineColorWT, 'LineWidth', LineWidth)%Plotting the means
hold on
plot(tx, StatsOfCells(:,1,3,2),'color', LineColorKO, 'LineWidth', LineWidth)%Plotting the means
